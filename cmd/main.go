...
import (
	...
	"github.com/jokestax/cluster-api-provider-civo/internal/controller"
...
func init() {
	...
	utilruntime.Must(infrastructureclusterxk8siov1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "cc522a99.my.domain",
	...
	if err = (&controller.CivoClusterReconciler{
	...
	if err = (&controller.CivoMachineReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
