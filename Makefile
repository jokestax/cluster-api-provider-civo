...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name capi-civo-builder
	$(CONTAINER_TOOL) buildx use capi-civo-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm capi-civo-builder
	rm Dockerfile.cross
...
.PHONY: release 
release: kustomize set-manifest-image release-manifests clean-release-git 
